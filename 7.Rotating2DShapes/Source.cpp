...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	HWND hwnd;
	MSG msg;
	TCHAR szClassName[] = TEXT("D3D11:2D Rotating Shapes Colored");
	bool bDone = false;
	...
	hwnd = CreateWindow(szClassName,
		TEXT("D3D11:Rotating 2D Shapes Color"),
		WS_OVERLAPPEDWINDOW,
		100,
		100,
		WIN_WIDTH,
...
HRESULT initialize(void)
{
	...
	*/
	...
	{
		0.39f,0.58f,0.92f,    //apex
		0.39f,0.58f,0.92f,  //right
		0.39f,0.58f,0.92f, //left
		0.39f,0.58f,0.92f, //left
	};
...
void display(void)
{
	...
	XMMATRIX rotationMatrix = XMMatrixRotationX(-angleTriangle); // +ve = right to left rotation, -ve = left to right rotation
