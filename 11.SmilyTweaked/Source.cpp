...
void display(void)
{
	...
	float textureQuadsVertices[12];
	if (digitPressed == 1)
	{
		textureQuadsVertices[0] = 0.0f;
		textureQuadsVertices[1] = 0.0f;
		textureQuadsVertices[2] = 0.0f;
		textureQuadsVertices[3] = 0.5f;
		textureQuadsVertices[4] = 0.5f;
		textureQuadsVertices[5] = 0.0f;
		textureQuadsVertices[6] = 0.5f;
		textureQuadsVertices[7] = 0.0f;
		textureQuadsVertices[8] = 0.0f;
		textureQuadsVertices[9] = 0.5f;
		textureQuadsVertices[10] = 0.5f;
		textureQuadsVertices[11] = 0.5f;
	}
	else if (digitPressed == 2)
	{
		...
		textureQuadsVertices[1] = 0.0f;
		textureQuadsVertices[2] = 0.0f;
		textureQuadsVertices[3] = 1.0f;
		textureQuadsVertices[4] = 1.0f;
		textureQuadsVertices[5] = 0.0f;
		textureQuadsVertices[6] = 1.0f;
		textureQuadsVertices[7] = 0.0f;
		textureQuadsVertices[8] = 0.0f;
		textureQuadsVertices[9] = 1.0f;
		textureQuadsVertices[10] = 1.0f;
		textureQuadsVertices[11] = 1.0f;
	}
	else if (digitPressed == 3)
	{
		...
		textureQuadsVertices[1] = 0.0f;
		textureQuadsVertices[2] = 0.0f;
		textureQuadsVertices[3] = 2.0f;
		textureQuadsVertices[4] = 2.0f;
		textureQuadsVertices[5] = 0.0f;
		textureQuadsVertices[6] = 2.0f;
		textureQuadsVertices[7] = 0.0f;
		textureQuadsVertices[8] = 0.0f;
		textureQuadsVertices[9] = 2.0f;
		textureQuadsVertices[10] = 2.0f;
		textureQuadsVertices[11] = 2.0f;
	}
	else if (digitPressed == 4)
	{
		textureQuadsVertices[0] = 0.5f;
		textureQuadsVertices[1] = 0.5f;
		textureQuadsVertices[2] = 0.5f;
		textureQuadsVertices[3] = 0.5f;
		textureQuadsVertices[4] = 0.5f;
		textureQuadsVertices[5] = 0.5f;
		textureQuadsVertices[6] = 0.5f;
		textureQuadsVertices[7] = 0.5f;
		textureQuadsVertices[8] = 0.5f;
		textureQuadsVertices[9] = 0.5f;
		textureQuadsVertices[10] = 0.5f;
		textureQuadsVertices[11] = 0.5f;
	}
	...
	ZeroMemory(&mappedSubresource, sizeof(D3D11_MAPPED_SUBRESOURCE));
	gpID3D11DeviceContext->Map(gpID3D11Buffer_VertexBuffer_Texture_Cube, NULL, D3D11_MAP_WRITE_DISCARD, NULL, &mappedSubresource); // map buffer
	memcpy(mappedSubresource.pData, textureQuadsVertices, sizeof(textureQuadsVertices));
	gpID3D11DeviceContext->Unmap(gpID3D11Buffer_VertexBuffer_Texture_Cube, NULL);
